...
namespace SignalRWebUI.ViewModels
{
    public class ContactViewModel
    {
        ...
        [StringLength(300, MinimumLength = 5,
            ErrorMessage = "Lokasyon en az 5, en fazla 300 karakter olmalıdır")]
        ...
        [StringLength(500, MinimumLength = 10,
            ErrorMessage = "Footer açıklaması en az 10, en fazla 500 karakter olmalıdır")]
        ...
        [StringLength(200, MinimumLength = 3,
            ErrorMessage = "Footer başlığı en az 3, en fazla 200 karakter olmalıdır")]
        ...
        [StringLength(100, MinimumLength = 3,
            ErrorMessage = "Açık günler en az 3, en fazla 100 karakter olmalıdır")]
        ...
        [StringLength(300, MinimumLength = 5,
            ErrorMessage = "Açık günler açıklaması en az 5, en fazla 300 karakter olmalıdır")]
        ...
        [StringLength(100, MinimumLength = 3,
            ErrorMessage = "Açık saatler en az 3, en fazla 100 karakter olmalıdır")]
