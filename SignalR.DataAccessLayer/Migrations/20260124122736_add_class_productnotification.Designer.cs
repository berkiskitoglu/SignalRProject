...
namespace SignalR.DataAccessLayer.Migrations
{
    ...
    [Migration("20260124122736_add_class_productnotification")]
    partial class add_class_productnotification
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.Category", b =>
                {
                    ...
                    b.ToTable("Categories", null, t =>
                        {
                            t.HasTrigger("tr_CategoryDeleted");

                            t.HasTrigger("tr_CategoryInserted");

                            t.HasTrigger("tr_CategoryUpdated");
                        });

                    b.HasAnnotation("SqlServer:UseSqlOutputClause", false);
                });

            modelBuilder.Entity("SignalR.EntityLayer.Entities.CategoryNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.Product", b =>
                {
                    ...
                    b.ToTable("Products", null, t =>
                        {
                            t.HasTrigger("tr_ProductDeleted");

                            t.HasTrigger("tr_ProductInserted");

                            t.HasTrigger("tr_ProductUpdated");
                        });

                    b.HasAnnotation("SqlServer:UseSqlOutputClause", false);
                });

            modelBuilder.Entity("SignalR.EntityLayer.Entities.ProductNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
